...
struct EditCategoryView: View {
    ...
    init(category: Category, onSave: @escaping (String, String, String) -> Void) {
                    ...
                    Circle()
                        ...
                        .overlay(
                            Circle()
                                .stroke(
                                    Color.white,
                                    lineWidth: selectedColor.toHex() == color.toHex() ? 3 : 0)
                        )
    ...
    private var saveButton: some View {
        Button(action: {
            let colorHex = selectedColor.toHex() ?? category.colorHex
...
// MARK: - Preview
#Preview {
    EditCategoryView(category: Category.sample) { _, _, _ in }
}
